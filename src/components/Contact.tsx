...
const Contact = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-slate-900 to-blue-900 text-white relative overflow-hidden" id="contact">
      {/* Background Pattern */}
          ...
          >
            ...
            {contactInfo.map((contact, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="glass-card p-6 hover:scale-105 transition-transform duration-300 bg-white/10 border-white/20">
